...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            {
                // testing, need to refactor

                #region tests

                //var testUser = new User() { UserName = model.Username };
                var testUser = new User() { UserName = "Jorge" };
                testUser.TestProperty = "Added from login";
                ...
                if (user != null && await _userManager.CheckPasswordAsync(user, "P467dffodama@"))
                {
